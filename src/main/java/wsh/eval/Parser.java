...
public class Parser {
    /**
     * Operators for assign
     */
    private static final Set<TokenType> TOKEN_TYPE_ASSIGN_OP_SET = Set.of(TokenType.ASSIGN, TokenType.ADD_ASSIGN,
